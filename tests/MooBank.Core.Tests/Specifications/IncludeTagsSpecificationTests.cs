...
/// <summary>
/// Unit tests for the <see cref="IncludeTagsSpecification"/> specification.
/// Tests verify that the specification correctly includes Splits with Tags.
/// </summary>
public class IncludeTagsSpecificationTests
{
    ...
    /// When IncludeTagsSpecification is applied
    ...
    public void Apply_WithTransactions_ReturnsAllTransactions()
    {
        ...
        var spec = new IncludeTagsSpecification();
