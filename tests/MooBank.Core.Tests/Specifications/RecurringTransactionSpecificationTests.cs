...
/// <summary>
/// Unit tests for the <see cref="RecurringTransactionSpecification"/> specification.
/// Tests verify that the specification correctly includes VirtualInstruments with RecurringTransactions.
/// </summary>
public class RecurringTransactionSpecificationTests
{
    #region Basic Application

    /// <summary>
    /// Given a collection of instruments
    /// When RecurringTransactionSpecification is applied
    ...
    public void Apply_WithInstruments_ReturnsAllInstruments()
    {
        ...
        var spec = new RecurringTransactionSpecification();
