...
public class TestEntities
{
    ...
    // Users
    public Domain.Entities.User.User CreateUser(Guid id = default, Guid familyId = default) =>
    ...
    public Domain.Entities.User.User Owner { get; }
    public Domain.Entities.User.User FamilyUser { get; }
    public Domain.Entities.User.User OtherUser { get; }
    ...
    public TestEntities()
    {
        Owner = new Domain.Entities.User.User(TestModels.UserId)
        {
            EmailAddress = "owner@mclachlan.family",
            FamilyId = TestModels.FamilyId,
        };

        FamilyUser = new Domain.Entities.User.User(new Guid("5a0cda81-3ab6-43d3-85e9-fa0e323881ff"))
        {
            EmailAddress = "family@mclachlan.family",
            FamilyId = TestModels.FamilyId,
        };

        OtherUser = new Domain.Entities.User.User(new Guid("88888888-8888-8888-8888-888888888888"))
        {
    ...
    // Tag Factory
    public Domain.Entities.Tag.Tag CreateTag(int id = 0, string? name = null) =>
