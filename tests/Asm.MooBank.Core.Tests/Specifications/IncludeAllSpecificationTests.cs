...
/// <summary>
/// Unit tests for the <see cref="IncludeAllSpecification"/> specification.
/// Tests verify that the specification correctly includes all related entities
/// (Splits, Tags, OffsetBy, OffsetFor, and User).
/// </summary>
public class IncludeAllSpecificationTests
{
    ...
    /// When IncludeAllSpecification is applied
    ...
    public void Apply_WithTransactions_ReturnsAllTransactions()
    {
        ...
        var spec = new IncludeAllSpecification();
