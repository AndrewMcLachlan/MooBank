...
/// <summary>
/// Unit tests for the <see cref="IncludeSplitsAndOffsetsSpecification"/> specification.
/// Tests verify that the specification correctly includes Splits with OffsetBy and OffsetFor.
/// </summary>
public class IncludeSplitsAndOffsetsSpecificationTests
{
    ...
    /// When IncludeSplitsAndOffsetsSpecification is applied
    ...
    public void Apply_WithTransactions_ReturnsAllTransactions()
    {
        ...
        var spec = new IncludeSplitsAndOffsetsSpecification();
