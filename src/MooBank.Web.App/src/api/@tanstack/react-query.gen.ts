...
import { addSubTag, addTag, addTagToInstrumentRule, allTagAverageReport, archiveForecastPlan, byTagReport, byTagReportForTag, closeInstitutionAccount, createAccount, createAsset, createBill, createBillAccount, createBudgetLine, createFamily, createForecastPlan, createGroup, createInstitution, createInstitutionAccount, createInstrumentRule, createPlannedItem, createRecurringTransaction, createRetirementPlan, createStockHolding, createStockTransaction, createTag, createTagByName, createTransaction, createVirtualInstrument, deleteAccountTagPurpose, deleteBudgetLine, deleteForecastPlan, deleteGroup, deleteInstrumentRule, deletePlannedItem, deleteRecurringTransaction, deleteRetirementPlan, deleteTag, deleteTransaction, deleteVirtualInstrument, generateBudget, getAccount, getAccounts, getAllBills, getAllBudgetYears, getAllFamilies, getAllForecastPlans, getAllGroups, getAllInstitutions, getAllInstrumentRules, getAllRetirementPlans, getAsset, getBill, getBillAccount, getBillAccounts, getBillAccountsByType, getBillAccountSummariesByType, getBillsByUtilityType, getBillsForAnAccount, getBudget, getBudgetAmountForTag, getBudgetLine, getBudgetReport, getBudgetReportBreakdownForMonth, getBudgetReportBreakdownForMonthForUnbudgetedItems, getBudgetReportForMonth, getChargeTypes, getCostPerUnitReport, getFamily, getForecastPlan, getFormattedInstrumentsList, getGroup, getInstitution, getInstitutionAccount, getInstrumentRule, getInstrumentsList, getMyFamily, getPaymentCandidates, getPlannedItem, getRecurringTransaction, getRecurringTransactions, getRetirementPeople, getRetirementPlan, getServiceChargeReport, getStockHolding, getStockHoldingCpiAdjustedGainLoss, getStockTransactions, getTag, getTagGraph, getTagHierarchy, getTags, getTransactionDeleteImpact, getTransactions, getUntaggedTransactions, getUsageReport, getUser, getVirtualInstrument, getVirtualInstruments, groupMonthlyBalancesReport, growthStrategyRates, import_, importBills, importerTypes, inOutAverageReport, inOutReport, inOutTrendReport, monthlyBalancesReport, monthlyBalancesReportForPeriod, monthlyBalancesReportFrom, type Options, pensionRates, principalVsInterestReport, removeFamilyMember, removeSubTag, removeTag, removeTagFromInstrumentRule, reorderGroups, reprocess, runForecast, runRetirementProjection, runRules, saveGrowthStrategyRate, savePensionRates, savingsInterestReport, searchTransactions, setAccountTagPurpose, setBalance, setPlannedItemPayments, stockHoldingReport, stockValueReport, superContributionsReport, superReturnsReport, tagBreakdownReport, tagBreakdownReportForTag, tagTrendReport, updateAccount, updateAsset, updateBill, updateBillAccount, updateBudgetLine, updateFamily, updateForecastPlan, updateGroup, updateInstitution, updateInstitutionAccount, updateInstrumentRule, updateMyFamily, updatePlannedItem, updateRecurringTransaction, updateRetirementPlan, updateStockHolding, updateTag, updateTransaction, updateUser, updateVirtualInstrument, updateVirtualInstrumentBalance } from '../sdk.gen';
import type { AddSubTagData, AddSubTagResponse, AddTagData, AddTagResponse, AddTagToInstrumentRuleData, AddTagToInstrumentRuleResponse, AllTagAverageReportData, AllTagAverageReportResponse, ArchiveForecastPlanData, ArchiveForecastPlanResponse, ByTagReportData, ByTagReportForTagData, ByTagReportForTagResponse, ByTagReportResponse, CloseInstitutionAccountData, CloseInstitutionAccountResponse, CreateAccountData, CreateAccountResponse, CreateAssetData, CreateAssetResponse, CreateBillAccountData, CreateBillAccountResponse, CreateBillData, CreateBillResponse, CreateBudgetLineData, CreateBudgetLineResponse, CreateFamilyData, CreateFamilyResponse, CreateForecastPlanData, CreateForecastPlanResponse, CreateGroupData, CreateGroupResponse, CreateInstitutionAccountData, CreateInstitutionAccountResponse, CreateInstitutionData, CreateInstitutionResponse, CreateInstrumentRuleData, CreateInstrumentRuleResponse, CreatePlannedItemData, CreatePlannedItemResponse, CreateRecurringTransactionData, CreateRecurringTransactionResponse, CreateRetirementPlanData, CreateRetirementPlanResponse, CreateStockHoldingData, CreateStockHoldingResponse, CreateStockTransactionData, CreateStockTransactionResponse, CreateTagByNameData, CreateTagByNameResponse, CreateTagData, CreateTagResponse, CreateTransactionData, CreateTransactionResponse, CreateVirtualInstrumentData, CreateVirtualInstrumentResponse, DeleteAccountTagPurposeData, DeleteAccountTagPurposeResponse, DeleteBudgetLineData, DeleteBudgetLineResponse, DeleteForecastPlanData, DeleteForecastPlanResponse, DeleteGroupData, DeleteGroupResponse, DeleteInstrumentRuleData, DeleteInstrumentRuleResponse, DeletePlannedItemData, DeletePlannedItemResponse, DeleteRecurringTransactionData, DeleteRecurringTransactionResponse, DeleteRetirementPlanData, DeleteRetirementPlanResponse, DeleteTagData, DeleteTagResponse, DeleteTransactionData, DeleteTransactionResponse, DeleteVirtualInstrumentData, DeleteVirtualInstrumentResponse, GenerateBudgetData, GenerateBudgetResponse, GetAccountData, GetAccountResponse, GetAccountsData, GetAccountsResponse, GetAllBillsData, GetAllBillsResponse, GetAllBudgetYearsData, GetAllBudgetYearsResponse, GetAllFamiliesData, GetAllFamiliesResponse, GetAllForecastPlansData, GetAllForecastPlansResponse, GetAllGroupsData, GetAllGroupsResponse, GetAllInstitutionsData, GetAllInstitutionsResponse, GetAllInstrumentRulesData, GetAllInstrumentRulesResponse, GetAllRetirementPlansData, GetAllRetirementPlansResponse, GetAssetData, GetAssetResponse, GetBillAccountData, GetBillAccountResponse, GetBillAccountsByTypeData, GetBillAccountsByTypeResponse, GetBillAccountsData, GetBillAccountsResponse, GetBillAccountSummariesByTypeData, GetBillAccountSummariesByTypeResponse, GetBillData, GetBillResponse, GetBillsByUtilityTypeData, GetBillsByUtilityTypeResponse, GetBillsForAnAccountData, GetBillsForAnAccountResponse, GetBudgetAmountForTagData, GetBudgetAmountForTagResponse, GetBudgetData, GetBudgetLineData, GetBudgetLineResponse, GetBudgetReportBreakdownForMonthData, GetBudgetReportBreakdownForMonthForUnbudgetedItemsData, GetBudgetReportBreakdownForMonthForUnbudgetedItemsResponse, GetBudgetReportBreakdownForMonthResponse, GetBudgetReportData, GetBudgetReportForMonthData, GetBudgetReportForMonthResponse, GetBudgetReportResponse, GetBudgetResponse, GetChargeTypesData, GetChargeTypesResponse, GetCostPerUnitReportData, GetCostPerUnitReportResponse, GetFamilyData, GetFamilyResponse, GetForecastPlanData, GetForecastPlanResponse, GetFormattedInstrumentsListData, GetFormattedInstrumentsListResponse, GetGroupData, GetGroupResponse, GetInstitutionAccountData, GetInstitutionAccountResponse, GetInstitutionData, GetInstitutionResponse, GetInstrumentRuleData, GetInstrumentRuleResponse, GetInstrumentsListData, GetInstrumentsListResponse, GetMyFamilyData, GetMyFamilyResponse, GetPaymentCandidatesData, GetPaymentCandidatesResponse, GetPlannedItemData, GetPlannedItemResponse, GetRecurringTransactionData, GetRecurringTransactionResponse, GetRecurringTransactionsData, GetRecurringTransactionsResponse, GetRetirementPeopleData, GetRetirementPeopleResponse, GetRetirementPlanData, GetRetirementPlanResponse, GetServiceChargeReportData, GetServiceChargeReportResponse, GetStockHoldingCpiAdjustedGainLossData, GetStockHoldingCpiAdjustedGainLossResponse, GetStockHoldingData, GetStockHoldingResponse, GetStockTransactionsData, GetStockTransactionsResponse, GetTagData, GetTagGraphData, GetTagGraphResponse, GetTagHierarchyData, GetTagHierarchyResponse, GetTagResponse, GetTagsData, GetTagsResponse, GetTransactionDeleteImpactData, GetTransactionDeleteImpactResponse, GetTransactionsData, GetTransactionsResponse, GetUntaggedTransactionsData, GetUntaggedTransactionsResponse, GetUsageReportData, GetUsageReportResponse, GetUserData, GetUserResponse, GetVirtualInstrumentData, GetVirtualInstrumentResponse, GetVirtualInstrumentsData, GetVirtualInstrumentsResponse, GroupMonthlyBalancesReportData, GroupMonthlyBalancesReportResponse, GrowthStrategyRatesData, GrowthStrategyRatesResponse, ImportBillsData, ImportBillsResponse, ImportData, ImporterTypesData, ImporterTypesResponse, InOutAverageReportData, InOutAverageReportResponse, InOutReportData, InOutReportResponse, InOutTrendReportData, InOutTrendReportResponse, MonthlyBalancesReportData, MonthlyBalancesReportForPeriodData, MonthlyBalancesReportForPeriodResponse, MonthlyBalancesReportFromData, MonthlyBalancesReportFromResponse, MonthlyBalancesReportResponse, PensionRatesData, PensionRatesResponse, PrincipalVsInterestReportData, PrincipalVsInterestReportResponse, RemoveFamilyMemberData, RemoveFamilyMemberResponse, RemoveSubTagData, RemoveSubTagResponse, RemoveTagData, RemoveTagFromInstrumentRuleData, RemoveTagFromInstrumentRuleResponse, RemoveTagResponse, ReorderGroupsData, ReorderGroupsResponse, ReprocessData, ReprocessResponse, RunForecastData, RunForecastResponse, RunRetirementProjectionData, RunRetirementProjectionResponse, RunRulesData, SaveGrowthStrategyRateData, SaveGrowthStrategyRateResponse, SavePensionRatesData, SavePensionRatesResponse, SavingsInterestReportData, SavingsInterestReportResponse, SearchTransactionsData, SearchTransactionsResponse, SetAccountTagPurposeData, SetAccountTagPurposeResponse, SetBalanceData, SetBalanceResponse, SetPlannedItemPaymentsData, SetPlannedItemPaymentsResponse, StockHoldingReportData, StockHoldingReportResponse, StockValueReportData, StockValueReportResponse, SuperContributionsReportData, SuperContributionsReportResponse, SuperReturnsReportData, SuperReturnsReportResponse, TagBreakdownReportData, TagBreakdownReportForTagData, TagBreakdownReportForTagResponse, TagBreakdownReportResponse, TagTrendReportData, TagTrendReportResponse, UpdateAccountData, UpdateAccountResponse, UpdateAssetData, UpdateAssetResponse, UpdateBillAccountData, UpdateBillAccountResponse, UpdateBillData, UpdateBillResponse, UpdateBudgetLineData, UpdateBudgetLineResponse, UpdateFamilyData, UpdateFamilyResponse, UpdateForecastPlanData, UpdateForecastPlanResponse, UpdateGroupData, UpdateGroupResponse, UpdateInstitutionAccountData, UpdateInstitutionAccountResponse, UpdateInstitutionData, UpdateInstitutionResponse, UpdateInstrumentRuleData, UpdateInstrumentRuleResponse, UpdateMyFamilyData, UpdateMyFamilyResponse, UpdatePlannedItemData, UpdatePlannedItemResponse, UpdateRecurringTransactionData, UpdateRecurringTransactionResponse, UpdateRetirementPlanData, UpdateRetirementPlanResponse, UpdateStockHoldingData, UpdateStockHoldingResponse, UpdateTagData, UpdateTagResponse, UpdateTransactionData, UpdateTransactionResponse, UpdateUserData, UpdateUserResponse, UpdateVirtualInstrumentBalanceData, UpdateVirtualInstrumentBalanceResponse, UpdateVirtualInstrumentData, UpdateVirtualInstrumentResponse } from '../types.gen';
...
export const setAccountTagPurposeMutation = (options?: Partial<Options<SetAccountTagPurposeData>>): UseMutationOptions<SetAccountTagPurposeResponse, AxiosError<DefaultError>, Options<SetAccountTagPurposeData>> => {
    const mutationOptions: UseMutationOptions<SetAccountTagPurposeResponse, AxiosError<DefaultError>, Options<SetAccountTagPurposeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setAccountTagPurpose({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const deleteAccountTagPurposeMutation = (options?: Partial<Options<DeleteAccountTagPurposeData>>): UseMutationOptions<DeleteAccountTagPurposeResponse, AxiosError<DefaultError>, Options<DeleteAccountTagPurposeData>> => {
    const mutationOptions: UseMutationOptions<DeleteAccountTagPurposeResponse, AxiosError<DefaultError>, Options<DeleteAccountTagPurposeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteAccountTagPurpose({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const updateBillAccountMutation = (options?: Partial<Options<UpdateBillAccountData>>): UseMutationOptions<UpdateBillAccountResponse, AxiosError<DefaultError>, Options<UpdateBillAccountData>> => {
    const mutationOptions: UseMutationOptions<UpdateBillAccountResponse, AxiosError<DefaultError>, Options<UpdateBillAccountData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateBillAccount({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const updateBillMutation = (options?: Partial<Options<UpdateBillData>>): UseMutationOptions<UpdateBillResponse, AxiosError<DefaultError>, Options<UpdateBillData>> => {
    const mutationOptions: UseMutationOptions<UpdateBillResponse, AxiosError<DefaultError>, Options<UpdateBillData>> = {
        mutationFn: async (fnOptions) => {
...
export const getChargeTypesQueryKey = (options?: Options<GetChargeTypesData>) => createQueryKey('getChargeTypes', options);

export const getChargeTypesOptions = (options?: Options<GetChargeTypesData>) => queryOptions<GetChargeTypesResponse, AxiosError<DefaultError>, GetChargeTypesResponse, ReturnType<typeof getChargeTypesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getChargeTypesQueryKey(options)
});
...
export const generateBudgetMutation = (options?: Partial<Options<GenerateBudgetData>>): UseMutationOptions<GenerateBudgetResponse, AxiosError<DefaultError>, Options<GenerateBudgetData>> => {
    const mutationOptions: UseMutationOptions<GenerateBudgetResponse, AxiosError<DefaultError>, Options<GenerateBudgetData>> = {
        mutationFn: async (fnOptions) => {
...
export const getPaymentCandidatesQueryKey = (options: Options<GetPaymentCandidatesData>) => createQueryKey('getPaymentCandidates', options);

export const getPaymentCandidatesOptions = (options: Options<GetPaymentCandidatesData>) => queryOptions<GetPaymentCandidatesResponse, AxiosError<DefaultError>, GetPaymentCandidatesResponse, ReturnType<typeof getPaymentCandidatesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getPaymentCandidates({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getPaymentCandidatesQueryKey(options)
});

export const setPlannedItemPaymentsMutation = (options?: Partial<Options<SetPlannedItemPaymentsData>>): UseMutationOptions<SetPlannedItemPaymentsResponse, AxiosError<DefaultError>, Options<SetPlannedItemPaymentsData>> => {
    const mutationOptions: UseMutationOptions<SetPlannedItemPaymentsResponse, AxiosError<DefaultError>, Options<SetPlannedItemPaymentsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await setPlannedItemPayments({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const reorderGroupsMutation = (options?: Partial<Options<ReorderGroupsData>>): UseMutationOptions<ReorderGroupsResponse, AxiosError<DefaultError>, Options<ReorderGroupsData>> => {
    const mutationOptions: UseMutationOptions<ReorderGroupsResponse, AxiosError<DefaultError>, Options<ReorderGroupsData>> = {
        mutationFn: async (fnOptions) => {
...
export const getRecurringTransactionsQueryKey = (options: Options<GetRecurringTransactionsData>) => createQueryKey('getRecurringTransactions', options);

export const getRecurringTransactionsOptions = (options: Options<GetRecurringTransactionsData>) => queryOptions<GetRecurringTransactionsResponse, AxiosError<DefaultError>, GetRecurringTransactionsResponse, ReturnType<typeof getRecurringTransactionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: getRecurringTransactionsQueryKey(options)
});
...
export const pensionRatesQueryKey = (options?: Options<PensionRatesData>) => createQueryKey('pensionRates', options);

export const pensionRatesOptions = (options?: Options<PensionRatesData>) => queryOptions<PensionRatesResponse, AxiosError<DefaultError>, PensionRatesResponse, ReturnType<typeof pensionRatesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await pensionRates({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: pensionRatesQueryKey(options)
});

export const savePensionRatesMutation = (options?: Partial<Options<SavePensionRatesData>>): UseMutationOptions<SavePensionRatesResponse, AxiosError<DefaultError>, Options<SavePensionRatesData>> => {
    const mutationOptions: UseMutationOptions<SavePensionRatesResponse, AxiosError<DefaultError>, Options<SavePensionRatesData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await savePensionRates({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const growthStrategyRatesQueryKey = (options?: Options<GrowthStrategyRatesData>) => createQueryKey('growthStrategyRates', options);

export const growthStrategyRatesOptions = (options?: Options<GrowthStrategyRatesData>) => queryOptions<GrowthStrategyRatesResponse, AxiosError<DefaultError>, GrowthStrategyRatesResponse, ReturnType<typeof growthStrategyRatesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await growthStrategyRates({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: growthStrategyRatesQueryKey(options)
});

export const saveGrowthStrategyRateMutation = (options?: Partial<Options<SaveGrowthStrategyRateData>>): UseMutationOptions<SaveGrowthStrategyRateResponse, AxiosError<DefaultError>, Options<SaveGrowthStrategyRateData>> => {
    const mutationOptions: UseMutationOptions<SaveGrowthStrategyRateResponse, AxiosError<DefaultError>, Options<SaveGrowthStrategyRateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await saveGrowthStrategyRate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const savingsInterestReportOptions = (options: Options<SavingsInterestReportData>) => queryOptions<SavingsInterestReportResponse, AxiosError<DefaultError>, SavingsInterestReportResponse, ReturnType<typeof savingsInterestReportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: savingsInterestReportQueryKey(options)
});
...
export const superContributionsReportOptions = (options: Options<SuperContributionsReportData>) => queryOptions<SuperContributionsReportResponse, AxiosError<DefaultError>, SuperContributionsReportResponse, ReturnType<typeof superContributionsReportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: superContributionsReportQueryKey(options)
});
...
export const superReturnsReportOptions = (options: Options<SuperReturnsReportData>) => queryOptions<SuperReturnsReportResponse, AxiosError<DefaultError>, SuperReturnsReportResponse, ReturnType<typeof superReturnsReportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const principalVsInterestReportQueryKey = (options: Options<PrincipalVsInterestReportData>) => createQueryKey('principalVsInterestReport', options);

export const principalVsInterestReportOptions = (options: Options<PrincipalVsInterestReportData>) => queryOptions<PrincipalVsInterestReportResponse, AxiosError<DefaultError>, PrincipalVsInterestReportResponse, ReturnType<typeof principalVsInterestReportQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: principalVsInterestReportQueryKey(options)
});
...
export const getAllRetirementPlansQueryKey = (options?: Options<GetAllRetirementPlansData>) => createQueryKey('getAllRetirementPlans', options);

export const getAllRetirementPlansOptions = (options?: Options<GetAllRetirementPlansData>) => queryOptions<GetAllRetirementPlansResponse, AxiosError<DefaultError>, GetAllRetirementPlansResponse, ReturnType<typeof getAllRetirementPlansQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getAllRetirementPlans({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getAllRetirementPlansQueryKey(options)
});

export const createRetirementPlanMutation = (options?: Partial<Options<CreateRetirementPlanData>>): UseMutationOptions<CreateRetirementPlanResponse, AxiosError<DefaultError>, Options<CreateRetirementPlanData>> => {
    const mutationOptions: UseMutationOptions<CreateRetirementPlanResponse, AxiosError<DefaultError>, Options<CreateRetirementPlanData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await createRetirementPlan({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getRetirementPeopleQueryKey = (options?: Options<GetRetirementPeopleData>) => createQueryKey('getRetirementPeople', options);

export const getRetirementPeopleOptions = (options?: Options<GetRetirementPeopleData>) => queryOptions<GetRetirementPeopleResponse, AxiosError<DefaultError>, GetRetirementPeopleResponse, ReturnType<typeof getRetirementPeopleQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getRetirementPeople({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getRetirementPeopleQueryKey(options)
});

export const deleteRetirementPlanMutation = (options?: Partial<Options<DeleteRetirementPlanData>>): UseMutationOptions<DeleteRetirementPlanResponse, AxiosError<DefaultError>, Options<DeleteRetirementPlanData>> => {
    const mutationOptions: UseMutationOptions<DeleteRetirementPlanResponse, AxiosError<DefaultError>, Options<DeleteRetirementPlanData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await deleteRetirementPlan({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getRetirementPlanQueryKey = (options: Options<GetRetirementPlanData>) => createQueryKey('getRetirementPlan', options);

export const getRetirementPlanOptions = (options: Options<GetRetirementPlanData>) => queryOptions<GetRetirementPlanResponse, AxiosError<DefaultError>, GetRetirementPlanResponse, ReturnType<typeof getRetirementPlanQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getRetirementPlan({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getRetirementPlanQueryKey(options)
});

export const updateRetirementPlanMutation = (options?: Partial<Options<UpdateRetirementPlanData>>): UseMutationOptions<UpdateRetirementPlanResponse, AxiosError<DefaultError>, Options<UpdateRetirementPlanData>> => {
    const mutationOptions: UseMutationOptions<UpdateRetirementPlanResponse, AxiosError<DefaultError>, Options<UpdateRetirementPlanData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await updateRetirementPlan({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const runRetirementProjectionMutation = (options?: Partial<Options<RunRetirementProjectionData>>): UseMutationOptions<RunRetirementProjectionResponse, AxiosError<DefaultError>, Options<RunRetirementProjectionData>> => {
    const mutationOptions: UseMutationOptions<RunRetirementProjectionResponse, AxiosError<DefaultError>, Options<RunRetirementProjectionData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await runRetirementProjection({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getTagGraphQueryKey = (options?: Options<GetTagGraphData>) => createQueryKey('getTagGraph', options);

export const getTagGraphOptions = (options?: Options<GetTagGraphData>) => queryOptions<GetTagGraphResponse, AxiosError<DefaultError>, GetTagGraphResponse, ReturnType<typeof getTagGraphQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getTagGraph({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getTagGraphQueryKey(options)
});
...
export const deleteTransactionMutation = (options?: Partial<Options<DeleteTransactionData>>): UseMutationOptions<DeleteTransactionResponse, AxiosError<DefaultError>, Options<DeleteTransactionData>> => {
    const mutationOptions: UseMutationOptions<DeleteTransactionResponse, AxiosError<DefaultError>, Options<DeleteTransactionData>> = {
        mutationFn: async (fnOptions) => {
...
export const getTransactionDeleteImpactQueryKey = (options: Options<GetTransactionDeleteImpactData>) => createQueryKey('getTransactionDeleteImpact', options);

export const getTransactionDeleteImpactOptions = (options: Options<GetTransactionDeleteImpactData>) => queryOptions<GetTransactionDeleteImpactResponse, AxiosError<DefaultError>, GetTransactionDeleteImpactResponse, ReturnType<typeof getTransactionDeleteImpactQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getTransactionDeleteImpact({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getTransactionDeleteImpactQueryKey(options)
});
