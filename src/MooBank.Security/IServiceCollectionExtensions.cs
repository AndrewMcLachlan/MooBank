...
public static class IServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddAuthorisationHandlers(this IServiceCollection services)
    {
        ...
        services.AddScoped<IAuthorizationHandler, TagFamilyResourceAuthorisationHandler>();
        ...
        services.AddScoped<IAuthorizationHandler, RetirementPlanAuthorisationHandler>();
