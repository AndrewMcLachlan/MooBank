...
internal class UpdateRuleHandler(IRuleRepository transactionTagRuleRepository, ISecurity securityRepository, IUnitOfWork unitOfWork) : ICommandHandler<Update, Queries.Rules.Rule>
{
