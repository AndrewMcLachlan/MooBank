...
(
    ...
    CONSTRAINT [FK_RecurringTransaction_VirtualAccount_Source] FOREIGN KEY ([SourceVirtualAccountId]) REFERENCES [VirtualAccount]([VirtualAccountId]), 
    CONSTRAINT [FK_RecurringTransaction_VirtualAccount_Destination] FOREIGN KEY ([DestinationVirtualAccountId]) REFERENCES [VirtualAccount]([VirtualAccountId])
)
