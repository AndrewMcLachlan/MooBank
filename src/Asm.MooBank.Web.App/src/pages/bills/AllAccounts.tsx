...
export const AllBillAccounts: React.FC = () => {
    ...
    return (
        <BillsPage
            ...
            actions={[
                <IconButton key="create" onClick={() => navigate("/bills/accounts/create")} icon="plus">Add Account</IconButton>
            ]}
        >
...
AllBillAccounts.displayName = "AllBillAccounts";
