...
internal sealed class AddSubTagHandler : CommandHandlerBase, ICommandHandler<AddSubTag, Tag>
{
    ...
    public async Task<Tag> Handle(AddSubTag request, CancellationToken cancellationToken)
    {
