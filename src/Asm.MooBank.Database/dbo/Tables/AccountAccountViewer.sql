...
(
    ...
    CONSTRAINT FK_AccountAccountViewer_Account FOREIGN KEY (AccountId) REFERENCES [Instrument]([Id]),
    CONSTRAINT FK_AccountAccountViewer_AccountHolder FOREIGN KEY (AccountHolderId) REFERENCES AccountHolder(AccountHolderId),
    CONSTRAINT FK_AccountAccountViewer_AccountGroup FOREIGN KEY (AccountGroupId) REFERENCES [dbo].[Group](Id),
)
