...
BEGIN
    ...
    DECLARE @OffsetAmount decimal(12,4) = @Amount - ISNULL((SELECT SUM(tso.Amount) FROM [TransactionSplitOffset] tso WHERE tso.TransactionId = @TransactionId AND tso.TransactionSplitId = @TransactionSplitId), 0)
