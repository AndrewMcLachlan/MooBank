...
{
    public static IQueryable<Transaction> IncludeAll(this IQueryable<Transaction> query) => query.Include(t => t.Tags).Include(t => t.OffsetBy).ThenInclude(t => t.OffsetByTransaction).Include(t => t.Offsets).ThenInclude(t => t.Transaction);
