...
internal class GetAllHandler(IQueryable<DomainInstitutionAccount> institutionAccounts, User user, ICurrencyConverter currencyConverter) : IQueryHandler<GetAll, IEnumerable<Models.Account.InstitutionAccount>>
{
