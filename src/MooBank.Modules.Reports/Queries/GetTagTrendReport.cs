...
internal class GetTagTrendReportHandler(IReportReader reportReader, IQueryable<Tag> tags, MooBank.Models.User user) : IQueryHandler<GetTagTrendReport, TagTrendReport>
{
